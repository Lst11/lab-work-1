...
public class UploadCommand extends BaseCommand {
    ...
    private void executeUpload() throws IOException {
        ...
        if (tcpConnection != null) {
            ...
            String[] confirmation = tcpConnection.read().split(" ");
            File file = new File(getAllTokens().get(AvailableToken.NAME.getName()));
            ...
            if (SUCCESS.equals(confirmation[0])) {
                try {
                    ...
                    tcpConnection.write(START_TRANSFER + " " + receivedBytes);
